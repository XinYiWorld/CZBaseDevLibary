...
public class BadgeView extends TextView {
	...
	public BadgeView(Context context, View target) {
		 this(context, null, android.R.attr.textViewStyle, target, 0,DEFAULT_WIDTH,DEFAULT_HEIGHT);
	}


	public BadgeView(Context context, View target, int widthDip, int heightDip) {
		this(context, null, android.R.attr.textViewStyle, target, 0,widthDip,heightDip);
	}
	...
	public BadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index,DEFAULT_WIDTH,DEFAULT_HEIGHT);
	}
	
	public BadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0,DEFAULT_WIDTH,DEFAULT_HEIGHT);
	}
	
	public BadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex, int widthDip, int heightDip) {
		super(context, attrs, defStyle);
		init(context, target, tabIndex,widthDip,heightDip);
	}

	private void init(Context context, View target, int tabIndex,int widthDip,int heightDip) {
		mWidth = widthDip == -2 ?  widthDip : dipToPixels(widthDip);
		mHeight = heightDip == -2 ? heightDip :  dipToPixels(heightDip);
	...
	private void applyTo(View target) {
		...
		if (target instanceof TabWidget) {
			...
			container.addView(this,new LayoutParams(mWidth,mHeight));

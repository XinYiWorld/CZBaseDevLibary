...
public final class x {
    private   static DbManager.DaoConfig defaultDaoConfig;
    ...
    public static DbManager getDefaultDb() {
        if(defaultDaoConfig != null){
            return DbManagerImpl.getInstance(defaultDaoConfig);
        }
        return null;
    }

    public static void setDefaultDaoConfig(DbManager.DaoConfig defaultDaoConfig) {
        x.defaultDaoConfig = defaultDaoConfig;
    }
